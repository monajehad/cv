												...
												<div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex align-items-center" style="background-color: #FFF4DE; background-position: left bottom; background-size: auto 100%; background-image: url({{asset('metronic/media/svg/humans/custom-2.svg')}})">
													<div class="row">
														...
														<div class="col-12 col-xl-7">
															...
															<p class="text-dark-50 my-5 font-size-xl font-weight-bold">add your course through the button to
                                                             add it inside your cv</p>
															<a href="#" class="btn btn-danger font-weight-bold py-2 px-6" aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#add_new_course">Add course </a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="card card-custom">
											<div class="card-header">
												<div class="card-title">
													...
													<h3 class="card-label">Your Course
