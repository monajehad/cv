									...
									<div class="card-body">
									 ...
									 <div class="card card-custom card-stretch gutter-b">
											<div class="card-body d-flex p-0">
												<div class="flex-grow-1 bg-light-success p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(80% + 0.9rem) bottom; background-size: 50% auto; background-image: url({{asset('metronic/media/port.jpg')}})">
													...
													<a href="#" class="btn btn-success font-weight-bolder btn-sm"  aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#add_new_portfolios">Add portfolios</a>
												</div>
											</div>
										</div>
										</div>
										...
										<div class="card card-custom">
                                            ...
                                            <div class="d-flex align-items-center bg-light-info rounded p-5 mb-9">
													...
													<div class="d-flex flex-column flex-grow-1 mr-2">
                                                        ...
                                                        <div class="font-weight-bold text-success mt-2 mb-5">date</div>
