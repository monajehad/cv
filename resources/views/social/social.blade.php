...
<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-center">
									<!--begin::Actions-->
									<a href="#" class="btn btn-light-primary font-weight-bolder btn-sm"  aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#save_social_modal">Add social</a>
                            </div>
                            </div>
							...
							<div class="container">
								...
								<!--begin::Card body-->
										...
										<div class="card-px text-center py-10 my-5">
											...
											<!--end::Description-->
											<!--begin::Action-->
											<a href="#" class="btn btn-primary" aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#save_social_modal">Add social</a>
											<!--end::Action-->
										</div>
										<!--end::Wrapper-->
										<!--begin::Illustration-->
                                ...
                                <br>
                                <!--begin::Card-->
									<div class="row" id="social_container">
...
@endsection
@section('script')
<script src="{{asset('js/blades/user/social/save_social.js')}}"></script>
<script src="{{asset('js/blades/user/social/index.js')}}"></script>
