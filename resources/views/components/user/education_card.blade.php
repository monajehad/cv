<div class="col-xl-6">
                ...
                <div class="d-flex flex-column flex-grow-1">
                    <a href="javascript:"
                       class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">
                        ...
                        <span>{{$education->place_name}}</span>
                    ...
                    <div class="d-flex">
                        <div class="d-flex align-items-center pr-5">
                            ...
                            <span class="text-muted font-weight-bold">{{$education->start_date}}</span>
                        </div>
                        <div class="d-flex align-items-center pr-5">
																<span class="svg-icon svg-icon-md svg-icon-primary pr-1">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Home/Clock.svg-->
                            ...
                            <span class="text-muted font-weight-bold">{{$education->end_date}}</span>
                        </div>
                        <div class="d-flex align-items-center">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M10.875,15.75 C10.6354167,15.75 10.3958333,15.6541667 10.2041667,15.4625 L8.2875,13.5458333 C7.90416667,13.1625 7.90416667,12.5875 8.2875,12.2041667 C8.67083333,11.8208333 9.29375,11.8208333 9.62916667,12.2041667 L10.875,13.45 L14.0375,10.2875 C14.4208333,9.90416667 14.9958333,9.90416667 15.3791667,10.2875 C15.7625,10.6708333 15.7625,11.2458333 15.3791667,11.6291667 L11.5458333,15.4625 C11.3541667,15.6541667 11.1145833,15.75 10.875,15.75 Z" fill="#000000"/>
            ...
            <div class="pt-3">
                <!--begin::Text-->
                <p class="text-dark-75 font-size-lg font-weight-normal pt-5">{{$education->details}}</p>
                <!--end::Text-->
                ...
                <div class="pt-5">
                    ...
                    <div class="card-toolbar mt-1 text-right">
                        <a href="#" class="btn btn-sm btn-icon btn-light-danger mr-2 delete_education_btn"
							onclick="remove('{{$education->id}}','user/education/delete')">
