						...
						<div class="col-xl-6">
									<div class="card card-custom gutter-b">
										...
										<div class="card-body">
											...
											<div class="d-flex align-items-center">
												...
												<div class="symbol symbol-45 symbol-light mr-5">
																	<span class="symbol-label">
																		<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Home\Building.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												...
												<div class="d-flex flex-column flex-grow-1">
													...
													class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">
														...
														<span class="m-2 text-primary">|</span>
                                                        <span>{{$work->job_title}} </span>
													</a>
													...
													<div class="d-flex">
														<div class="d-flex align-items-center pr-5">
															...
															<span class="text-muted font-weight-bold">{{$work->start_date}}</span>
														</div>
														<div class="d-flex align-items-center pr-5">
																								<span class="svg-icon svg-icon-md svg-icon-primary pr-1">
																									<!--begin::Svg Icon | path:assets/media/svg/icons/Home/Clock.svg-->
															...
															<span class="text-muted font-weight-bold">{{$work->end_date}}</span>
														</div>
											...
											<div class="pt-3">
												<!--begin::Text-->
												<p class="text-dark-75 font-size-lg font-weight-normal pt-5">{{$work->details}}</p>
												<!--end::Text-->
